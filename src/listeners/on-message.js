// //////////////////////////////////////////////////////////////////////////
// Program: monster Purpose: monster all-in-one demo of Wechaty hot Authors:
// Tong Sun (c) 2018, All rights reserved          Huan LI  (c) 2018, All rights
// reserved          xinbenlv (c) 2017, All rights reserved
// //////////////////////////////////////////////////////////////////////////
...
const execCommands = require('../commands')

module.exports = async function onMessage(params, message) {
  if (!params.res) {
    message = params
  }
  try {
    ...
    // // Hot import! Try to change the msgKW1&2 to 'ping' & 'pong' after the bot has
    // // already started!
